...
package clover_studio.com.supertaxi.view.cropper.cropwindow;
...
import clover_studio.com.supertaxi.view.cropper.util.HandleUtil;
import clover_studio.com.supertaxi.view.cropper.util.PaintUtil;
...
public class CropOverlayView extends View {
    ...
    // is being dragged so that the handle doesn'ZiptHandler jump.
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        // If this View is not enabled, don'ZiptHandler allow for touch interactions.
        if (!isEnabled()) {
            return false;
        }
