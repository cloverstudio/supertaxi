package clover_studio.com.supertaxi.view.touchable_map;
...
public abstract class MapStateListener {
    ...
    public MapStateListener(GoogleMap map, TouchableMapFragment touchableMapFragment, Activity activity) {
        ...
        map.setOnCameraChangeListener(new GoogleMap.OnCameraChangeListener() {
            ...
            public void onCameraChange(CameraPosition cameraPosition) {
                onMapChangeCamera(cameraPosition);
                unsettleMap();
                if(!mMapTouched) {
                    runSettleTimer();
                }
    ...
    public abstract void onMapChangeCamera(CameraPosition cameraPosition);
}
