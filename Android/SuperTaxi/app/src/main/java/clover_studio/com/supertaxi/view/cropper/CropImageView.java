...
package clover_studio.com.supertaxi.view.cropper;
...
import clover_studio.com.supertaxi.view.TouchImageView;
import clover_studio.com.supertaxi.view.cropper.cropwindow.CropOverlayView;
import clover_studio.com.supertaxi.view.cropper.cropwindow.edge.Edge;
import clover_studio.com.supertaxi.view.cropper.util.ImageViewUtil;
...
//            mCropOverlayView.setBitmapRect(new Rect());
    ...
    private static int getOnMeasureSpec(int measureSpecMode, int measureSpecSize, int desiredSize) {
        ...
        if (measureSpecMode == MeasureSpec.EXACTLY) {
            ...
            // Can'ZiptHandler be bigger than...; match_parent value
    ...
    public Rect getRealBitmapRect() {
        return ImageViewUtil.getBitmapRectCenterInside(mBitmap, mImageView);
    }
